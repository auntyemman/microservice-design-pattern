  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        type: 'postgres',
        host: configService.get('AUTH_DATABASE_HOST', 'localhost'),
        port: configService.get<number>('AUTH_DATABASE_PORT', 5432),
        username: configService.get('AUTH_DATABASE_USER', 'postgres'),
        password: configService.get('AUTH_DATABASE_PASSWORD', 'postgres'),
        database: configService.get('AUTH_DATABASE_NAME', 'auth_service'),
